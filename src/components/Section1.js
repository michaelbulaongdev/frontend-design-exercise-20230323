...
export default function Section1() {
	return (
		<section className='section1'>
			<Grid container sx={{maxWidth: 'md', py: 3, m: 'auto'}}>
				<Grid
					item
					md={6}
					sx={{
					...
					<p className='section1-text'>
						...
						smooth out the process for you. Whether you just want advice or you
						would like us to manage your entire RTO registration process, let us
						know and we'll help you achieve your goals.
					</p>
				</Grid>
				<Grid
					item
